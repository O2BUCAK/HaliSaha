...
const Dashboard = () => {
    ...
    let seoTitle = 'Yönetim Paneli';
    let seoDesc = 'Halı saha lig yönetimi, oyuncu puanları ve maç analizlerini buradan yönetebilirsiniz.';

    if (location.pathname === '/dashboard') {
        seoTitle = 'Genel Bakış';
        seoDesc = 'Halı saha maç istatistikleri, haftalık performanslar ve güncel lig tabloları.';
    } else if (location.pathname === '/dashboard/groups') {
        seoTitle = 'Gruplarım';
        seoDesc = 'Kayıtlı olduğunuz halı saha gruplarını ve liglerini görüntüleyin.';
    } else if (location.pathname === '/dashboard/groups/create') {
        seoTitle = 'Yeni Grup Oluştur';
        seoDesc = 'Yeni bir halı saha ligi başlatın, arkadaşlarınızı ekleyin ve maç yapmaya başlayın.';
    }
